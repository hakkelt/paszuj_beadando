...
int main() {
    ...
    set<string> varosnev;
    //esetleg A1tkA¶zA‘ nevek miatt set
    ...
    //indexelhetA‘sA©g kedvA©A©rt vectorba tesszA1k ezeket
    ...
    for (unsigned int i=0;i<jaratszam;i++) {
        string kod = v_jaratkod[i]; // itt nincs random, minden jA!ratnak pontosan egyszer kell szerepelnie
